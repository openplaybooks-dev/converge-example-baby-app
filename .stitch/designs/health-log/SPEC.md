...
| `warmWhite` | `#FFFFFF` | Bottom nav background, FAB surface, bottom sheets |
...
- `BottomNavigationBar`: Hidden (per UX.md 3.6)
...
- Entry type indicator: Left border accent (4dp wide)
  - SymptomEntry: `lavenderBloom` (#7C3AED)
  - DoctorVisit: `blushRose` (#F9A8D4)
  - Reminder: `softMint` (#6EE7B7)
...
- FAB to sheet: 250ms smooth deceleration slide-up
