---
id: 002-browse-01-spec
title: "Spec: Browse"
description: Generate Browse screen specification
inputs:
...
checks:
  - id: spec-exists
    type: cmd
    cmd: test -f .stitch/designs/browse/SPEC.md
    description: SPEC.md exists for browse
  - id: spec-has-content
    type: cmd
    cmd: test $(wc -l < .stitch/designs/browse/SPEC.md) -gt 50
...
Generate the screen specification for **Browse** (`/browse`).
...
Read inputs and produce `.stitch/designs/browse/SPEC.md` containing:

1. **Screen Title** — Browse
2. **Purpose** — What this screen does and why
3. **Route** — `/browse`
4. **Widget Name** — `BrowseScreen`
...
- `.stitch/designs/browse/SPEC.md` exists and has >50 lines
