# Task: 009-health-log-06-lift

# Lift: Health Log

Lift each widget in `lib/screens/health_log/_widgets/` marked `shared: true` in `.stitch/designs/health-log/widgets.jsonl` to `lib/widgets/` — one spawn per shared widget.
