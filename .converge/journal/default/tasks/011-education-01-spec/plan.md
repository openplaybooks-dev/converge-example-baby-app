...
Now I have all the context needed. Let me compile the Education screen specification.
...
### Colors (Light Theme — from DESIGN.md / UX.md)
...
### Typography (Nunito — Google Fonts from DESIGN.md)
...
- Title: "Featured Article" prefix label (`caption`, `stoneGrey`) + Article title (`displayLarge` 28sp, `deepGraphite`)
...
- `ArticleTopic` enum: `nutrition`, `bodyChanges`, `maternalCare`, `babyDevelopment`
...
| `babyDevelopment` | Baby Development | `Icons.child_care_outlined` |
