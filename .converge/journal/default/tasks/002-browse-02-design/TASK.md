---
id: 002-browse-02-design
title: "Design: Browse"
description: Generate constrained HTML design for Browse using Flutter HTML Glossary
inputs:
...
checks:
  - id: design-exists
    type: cmd
    cmd: test -f .stitch/designs/browse/design.html
    description: design.html exists for browse
  - id: meta-exists
    type: cmd
    cmd: test -f .stitch/designs/browse/META.md
    description: META.md exists for browse
  - id: uses-glossary
    type: cmd
    cmd: grep -q 'class="scaffold"' .stitch/designs/browse/design.html
    description: HTML uses Flutter HTML Glossary vocabulary
  - id: has-data-attributes
    type: cmd
    cmd: grep -q 'data-color=' .stitch/designs/browse/design.html
...
vars:
  ...
  screenId: browse
  title: Browse
  specPath: .stitch/designs/browse/SPEC.md
  metaPath: .stitch/designs/browse/META.md
  designPath: .stitch/designs/browse/design.html
---

# Design: Browse

Generate the HTML design mockup for **Browse** using the **Flutter HTML Glossary** constrained vocabulary.
...
## Inputs
- `.stitch/designs/browse/SPEC.md` — Screen specification
- `.stitch/system/DESIGN.md` — Design system
- `.stitch/system/META.md` — Reference examples metadata

## Steps

1. **Read spec** — Load `.stitch/designs/browse/SPEC.md` to understand layout, sections, data
...
5. **Generate META.md** — Write `.stitch/designs/browse/META.md` with example selection and scoring table
6. **Generate design.html** — Write `.stitch/designs/browse/design.html` following `stitch-generate` skill using ONLY glossary elements
...
- `.stitch/designs/browse/META.md` — Example selection and scoring
- `.stitch/designs/browse/design.html` — Self-contained HTML mockup at 375px using glossary vocabulary
