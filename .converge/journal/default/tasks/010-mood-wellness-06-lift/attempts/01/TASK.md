# Task: 010-mood-wellness-06-lift

# Lift: Mood & Wellness

Lift each widget in `lib/screens/mood_wellness/_widgets/` marked `shared: true` in `.stitch/designs/mood-wellness/widgets.jsonl` to `lib/widgets/` — one spawn per shared widget.
